...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "127.0.0.1:8000", "sharon-series-striking-only.trycloudflare.com", "posey-frontend-y8so.vercel.app"]
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:8000",
    "http://127.0.0.1:4040",
    "https://sharon-series-striking-only.trycloudflare.com",
